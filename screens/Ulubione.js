...
import { View, StyleSheet, Text, ImageBackground, FlatList, Animated, TouchableHighlight, AsyncStorage } from 'react-native';
...
const Ulubione = props => {
    ...
    return (
        <Stack.Navigator initialRouteName="Ulubione" screenOptions={ScreenStyle}>
            <Stack.Screen name="Ulubione" component={UlubioneScreen}
                options={{
